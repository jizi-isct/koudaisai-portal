...
datatest_stable::harness! {
    ...
    { test = application::authz::test_can_update_own_events26_menu, root = "tests/fixtures/application", pattern = r"authz/can_update_own_events26_menu/[^/]+\.json" },
    // application::user
    ...
    { test = application::events26::test_update_own_project_menu, root = "tests/fixtures/application", pattern = r"events26/update_own_project_menu/[^/]+\.json" },
    { test = application::events26::test_delete_own_project_menu, root = "tests/fixtures/application", pattern = r"events26/delete_own_project_menu/[^/]+\.json" },
