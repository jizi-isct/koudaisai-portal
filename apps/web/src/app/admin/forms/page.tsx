...
import {$apiAdmin, FormRead} from "@/lib";
    ...
    const columns: TableProps<FormRead>['columns'] = [
        {
            ...
            render: (value, record, _index) => <a
              ...
              href={process.env.NEXT_PUBLIC_ADMIN_BASE_PATH + "/forms/edit?form_id=" + record.id}
            >
                {value}
            </a>
        },
      ...
      <>
          ...
          <Flex gap={8} vertical>
              <Button style={{width: "fit-content"}}
                      href={process.env.NEXT_PUBLIC_ADMIN_BASE_PATH + "/forms/new"}><PlusOutlined/>新規作成</Button>
              <Table<FormRead>
