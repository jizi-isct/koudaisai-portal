...
export function ResetPasswordRequestForm() {
  ...
  return (
    <form className={styles.root} action="/reset-password/" method="post" onSubmit={handleSubmit}>
      ...
      <NextPhaseButton type="submit" label="工大祭ポータルに進む" disabled={isSubmitting} aria-busy={isSubmitting} />
    </form>
  );
}
