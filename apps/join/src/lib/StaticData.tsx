    ...
    [
      {
        ...
        date: "===日付不明===",
        children: <>
          6/19(金)の参加資格通知または6/26(金)までの補欠合格発表で合格の通知があった団体の方は===日付不明===までに参加申込金を振り込んでください。
        </>
      },
      {
        title: "第一回参加団体総会",
      ...
      {
        title: "模擬店企画向け面談",
        date: "8/7(金), 8/8(土), 8/17(月), 8/18(火), 8/19(水)",
        children: <>
    ...
    [
      {
        ...
        date: "===日付不明===",
        children: <>
          6/19(金)の参加資格通知または7/2(水)までの補欠合格発表で合格の通知があった団体の方は===日付不明===までに参加申込金を振り込んでください。
        </>
      },
      {
        title: "一般企画場所決定会",
        date: "7/1(水)",
        children: <>
          希望場所が重複している場合、===日付不明===までに通知いたしますので、ご出席ください。
        </>
      },
      {
        title: "第一回参加団体総会",
  ...
  stage: [
    ...
    [
      ...
      },
      {
        ...
        date: "===日付不明===",
        children: <>
          6/19(金)の参加資格通知または7/1(水)までの補欠合格発表で合格の通知があった団体の方は===日付不明===までに参加申込金を振り込んでください。
        </>
      },
      {
        title: "第一回参加団体総会",
