  ...
  booth: [
    ...
    [
      ...
      },
      {
        ...
        children: (
          <>
            責任者3名に出席していただく必要がございます。資料は<DocumentLink />から
          </>
        ),
      },
      {
  ...
  general: [
    ...
    [
      ...
      },
      {
        title: "参加申込金振り込み",
        date: "～7/7(火)",
        children: <>6/19(金)の参加資格通知または7/2(木)の補欠合格発表で合格の通知があった団体の方は7/7(火)までに参加申込金を振り込んでください。</>,
      },
      {
        title: "第一回参加団体総会",
        date: "7/8(水)",
      ...
      },
      {
        title: "事前安全講習会+第二回参加団体総会",
        date: "9/16(水)",
        children: <>責任者のうち1名に出席していただく必要がございます。資料は<DocumentLink />から</>,
      },
      {
        title: "第三回参加団体総会",
        date: "10/7(水)",
