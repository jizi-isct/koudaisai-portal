    ...
    [
      {
        ...
        children: (
          <>
            6/19(金)の参加資格通知または6/26(金)の補欠合格の通知があった団体の方は7/1(水)までに参加申込金を振り込んでください。
          </>
        ),
      },
      {
      ...
      },
      {
        ...
        children: (
          <>
            企画内容、食品の取り扱い、電源、レンタル品の申請を行なっていただきます。詳しくは第一回参加団体総会にてご説明します。
          </>
        ),
      },
      {
        ...
        children: (
          <>
            申請内容の最終確認と修正をしていただきます。模擬店申請らくらくパックを利用する団体は来ていただく必要はございません。
          </>
        ),
      },
      {
        ...
        children: (
          <>
            責任者3名に出席していただく必要がございます。また、第二回参加団体総会も付随しての開催となります。資料は
            <DocumentLink />
            から
          </>
        ),
    ...
    [
      {
        ...
        children: (
          <>
            希望場所が重複している場合、6/26(金)までに通知いたしますので、ご出席ください。
          </>
        ),
      },
      {
        ...
        children: (
          <>
            6/19(金)の参加資格通知または7/3(金)の補欠合格発表で合格の通知があった団体の方は7/7(火)までに参加申込金を振り込んでください。
          </>
        ),
      },
      {
      ...
      },
      {
        ...
        children: (
          <>
            責任者のうち1名に出席していただく必要がございます。また、第二回参加団体総会も付随しての開催となります。資料は
            <DocumentLink />
            から
          </>
        ),
    ...
    [
      {
        ...
        children: (
          <>
            タイムテーブルを決定しますので、ご出席ください。(野外ステージのみに参加する団体は参加される必要はございません。)
          </>
        ),
      },
      {
      ...
      },
      {
        ...
        children: (
          <>
            全団体に出席義務があり、責任者のうち少なくとも1名の出席が必要です。資料は
            <DocumentLink />
            から
          </>
        ),
