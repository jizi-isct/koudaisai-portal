...
export function Steps({steps}: Props) {
  ...
  return (
    <div className="relative overflow-visible py-[2em] min-[1150px]:pt-[2em] min-[1150px]:pb-0">
      {
        stepChunks.map((stepChunk, i) =>
          <div
            key={`steps-${i}`}
            className="flex justify-center items-center overflow-visible max-[1150px]:flex-col min-[1150px]:flex-row min-[1150px]:w-screen min-[1150px]:gap-[10px] min-[1150px]:relative min-[1150px]:left-1/2 min-[1150px]:-translate-x-1/2 min-[1150px]:mb-8"
          >
            <svg className="max-[1150px]:hidden" width="102" height="24" viewBox="0 0 102 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className="max-[1150px]:hidden" width="100" height="3" viewBox="0 0 100 3" fill="none" xmlns="http://www.w3.org/2000/svg">
