...
import {chunk} from "@koudaisai-portal/util";
        ...
        stepChunks.map((stepChunk, i) =>
          <div className={styles.steps}>
            <svg className={styles.arrow} width="102" height="24" viewBox="0 0 102 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <line y1="12" x2="50" y2="12" stroke={i === 0 ? "transparent" : "#253661"} stroke-width="3" stroke-dasharray="6 6"/>
            ...
            </svg>
            {
              stepChunk.map((step, j) =>
                <Step title={step.title} date={step.date} isFirst={i === 0 && j === 0}>
                  {step.children}
                </Step>
              )
            }
            <svg className={styles.arrow} width="100" height="3" viewBox="0 0 100 3" fill="none" xmlns="http://www.w3.org/2000/svg">
              <line y1="1.5" x2="50" y2="1.5" stroke={i === stepChunks.length - 1  ? "transparent" : "#253661"} stroke-width="3"/>
              <line x1="50" y1="1.5" x2="100" y2="1.5" stroke={i === stepChunks.length - 1  ? "transparent" : "#253661"}  stroke-width="3" stroke-dasharray="6 6"/>
            </svg>
          </div>
        )
      }
