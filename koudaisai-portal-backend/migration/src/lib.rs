...
mod m20250227_191323_create_table_form_items;
mod m20250227_191436_create_table_form_questions;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20250227_191323_create_table_form_items::Migration),
            Box::new(m20250227_191436_create_table_form_questions::Migration),
